        ...
        <div className="glass" style={{ padding: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            ...
            {candidate.resumePath && (
              <a href={`http://localhost:5000${candidate.resumePath}`} target="_blank" rel="noopener noreferrer" className="btn" style={{ padding: '0.5rem 1rem', background: 'rgba(99,102,241,0.1)', color: 'var(--accent)', borderRadius: '6px', fontSize: '0.85rem', textAlign: 'center', marginTop: '0.5rem' }}>
